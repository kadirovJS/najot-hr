...
export default function VacancyDetailView({ vacancy }: { vacancy: IVacancy }) {
        ...
        <section className="detail-hero">
          <div className="site-container">
            ...
            <div data-detail-hero className="detail-facts">
              ...
              <div><Clock3/><span>E’lon sanasi<strong>{formatUzDateLong(vacancy.createdAt)}</strong></span></div>
